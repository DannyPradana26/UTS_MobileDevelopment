package uts.DannyPradana.mobile.network

import uts.DannyPradana.mobile.activity.data_barang.data.ResultDataBarang
import uts.DannyPradana.mobile.activity.login.data.ResultLogin
import uts.DannyPradana.mobile.activity.penjualan.data.ResultKeranjang
import uts.DannyPradana.mobile.activity.penjualan.data.ResultSearchBarang
import uts.DannyPradana.mobile.activity.report.detail.data.ResultItemKeranjang
import uts.DannyPradana.mobile.response.ResultSimple
